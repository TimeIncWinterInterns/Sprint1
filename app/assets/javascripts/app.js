		...
		var posterGender = $('#authorgender').val();
			...
			$.ajax({
				...
				for(i=0; i < data.length; i++){
					...
					var p_video_preview = document.createElement("iframe");
					...
					document.body.appendChild(p_video_preview);
					...
					p_video_preview.src = data[i].video_url;
					p_video_preview.width="560"
					p_video_preview.height="315"
					...
					$('div#information').append(p_video_preview)
				}
			}).fail(function(data){
				console.log("failed")
			})
